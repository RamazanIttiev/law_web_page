...
export const insuranceCases = [
  {
    ...
    problems: [
      ...
      'Страховые компании, как правило содержат     / большой штат высококлассных юристов /   . Их основная задача – это не дать делу развития и постараться     /   развалить дело на начальном этапе /     . Кроме того, имея богатый опыт ведения дел, они профессионально преподносят в суде информацию, уводя внимание от важных фактов и направляя ход рассмотрения в нужное русло. ',
