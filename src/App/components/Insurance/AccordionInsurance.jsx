      ...
      <Container maxWidth="lg">
        ...
        <Accordion sx={{ width: `${mobileScreen && '100%'}`, marginBottom: 4, padding: 2 }}>
          ...
          <Details>
            <List>
              ...
              Споры между страховыми компаниями и автовладельцами являются самым часто встречающимся
              примером данной категории. При этом даже наличие всех необходимых документов,
              подтверждающих наступление страхового случая, не всегда ведет к получению
              страхователями полагающихся страховых выплат.
              <br />
              <br />
        ...
        <Accordion sx={{ width: `${mobileScreen && '100%'}`, marginBottom: 4, padding: 2 }}>
          ...
          <Details>
            ...
            подобных платежей является полис добровольного страхования заемщика, стоимость которого
            составляет до 15% общей суммы кредита.
            <br />
            <br />В том случае, если клиент не хочет осуществлять дополнительные платежи, сотрудники
            ...
            что, на первый взгяд, может показаться выгодным. В результате клиент банка уже не тратит
            ...
            кажется, действуют в соответствии с требованием закона, и не замечают грубые нарушения,
            которые сотрудники умело скрывают.
          </Details>
        </Accordion>
        <Accordion sx={{ width: `${mobileScreen && '100%'}`, marginBottom: 4, padding: 2 }}>
          <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          ...
          <Details>
            ...
            <br />
            <br />В таком случае, при отказе страховой компании в возврате неизрасходованной части
            ...
            исполнения страховой компанией обязанности по возврату денег, морального вреда, штрафа в
            размере 50% от присужденной суммы и судебных расходов.
          </Details>
        </Accordion>
      </Container>
    </Base>
